...
Users may create multiple widgets per book. In this experiment there is more than once experimental factor, so we can create another widget based on a different group. We may also use the optional y-axis label anf plot title arguments argument.
