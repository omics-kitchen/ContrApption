...
# data table example from R crosstalks' site
datatable(
  normCountsSigShared,
  extensions = "Scroller",
  style = "bootstrap",
...
A selection in the table will be reflected in ContrApption if the user passes the same shared data object:
...
bscols(
  ...
  # second column
  ContrApption(data = normCountsSigShared, annotation = coldata, bscolSize = TRUE)
)
```
```{R}
